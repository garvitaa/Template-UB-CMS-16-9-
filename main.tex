...
\addtobeamertemplate{footline}{\fontsize{2.15mm}{2.2mm}\selectfont\flushleft\hspace*{2ex}\insertshortauthor\hspace*{45ex}\insertshorttitle\hspace*{32ex}}
...
\usebackgroundtemplate{\includegraphics[width = 16cm, height = 9cm]{background/UB_background_title_widescreen.pdf}}

%%%%%%%%% Uncomment the below line to use UB template
% \usebackgroundtemplate{\includegraphics[width = 16cm, height = 9cm]{background/UBTemplate_titlepage_widescreen.pdf}}
...
%	PRESENTATION SLIDES
%---------------------------------------------------------------------------
%%%%%%%%% Uncomment the below three lines to use UB-CMS template
\usebackgroundtemplate{\includegraphics[width = 16cm, height = 9cm]{background/background_widescreen.pdf}}
\setbeamertemplate{frametitle}[default][center]

%%%%%%%%% Uncomment the below three lines to use UB template
% \usebackgroundtemplate{\includegraphics[width = 16cm, height = 9cm]{background/UBTemplate_background_widescreen.pdf}}
...
% \end{frame}}
%----------------------------------------------------------------------------------------
\begin{frame}{\textbf{Extra Stuff}}\vspace{3.5mm}
